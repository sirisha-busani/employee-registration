package com.snipe.insurancemonster.auth.common;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonInclude;
import static org.apache.http.HttpStatus.SC_OK;
import static com.snipe.insurancemonster.auth.exception.IMonRestException.INTERNAL_ERROR_CODE;
...
import com.snipe.insurancemonster.auth.exception.IMonRestException;

import static com.snipe.insurancemonster.auth.common.Status.SUCCESS;
import static com.snipe.insurancemonster.auth.common.Status.FAILURE;
...
public class GenericRes<T> {
	...
	public GenericRes(Throwable exception) {
		...
		if (exception instanceof IMonRestException) {
			IMonRestException ae = (IMonRestException) exception;
			status = FAILURE;
